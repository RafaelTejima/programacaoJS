...
let time1 = parseInt(prompt("Insira o nome do primeiro time: "))
let time2 = parseInt(prompt("Insira o nome do segundo time: "))
let gol_time1 = parseInt(prompt("\nInsira quantos gols time " +time1+ " fez:"))
let gol_time2 = parseInt(prompt("Insira quantos gols o time " +time2+ " fez:"))
